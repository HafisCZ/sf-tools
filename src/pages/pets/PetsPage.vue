...
import { type PetHabitat, type PlayerModel } from '~/core/models/player'
...
import { CONFIG, SimulatorModel } from '~/sim/base'
...
import { PetModel, type SimulatorPet } from '~/sim/pets'
