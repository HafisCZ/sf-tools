...
const Loca = {
  ...
  name : function (itemType, itemIndex, itemClass) {
      if (itemClass == undefined || itemType >= 8) {
          return this.translations[`item type ${this.fill(itemType, 2)} pic ${this.fill(itemIndex, 3)}`];
      } else {
          if (itemType > 1 && itemIndex >= 100) {
              itemClass = 1;
          }

          return this.translations[`item type ${this.fill(itemType, 2)} class ${itemClass} pic ${this.fill(itemIndex, 3)}`];
      }
  },
  ...
  translations: {
    ...
    'item type 01 class 1 pic 104': 'Sinbad\'s Saber',
    ...
    'item type 01 class 2 pic 104': 'Dimensional Cube',
    ...
    'item type 01 class 3 pic 104': 'Artemis\' Bow',
    ...
    'item type 02 class 1 pic 104': 'Valkyrie\'s Wall',
    ...
    'item type 03 class 1 pic 106': 'Uschi\'s Kraken Dress',
    ...
    'item type 04 class 1 pic 104': '11.27 Kilometer Boots',
    ...
    'item type 05 class 1 pic 106': 'Armed Hands',
    ...
    'item type 06 class 1 pic 107': 'Nestling\'s Toupee',
    ...
    'item type 07 class 1 pic 104': 'Ariadne\'s Navigation Belt',
    'item type 07 class 1 pic 105': 'Sam\'s Rope',
    'item type 07 class 1 pic 107': 'Janitor\'s Keychain',
    ...
    'item type 08 pic 107': 'Coin Amulet of the World Hopper',
    ...
    'item type 09 pic 106': 'Baba Yaga\'s Cursed Claw Ring',
