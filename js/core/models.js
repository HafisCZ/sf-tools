...
class PlayerModel {
    static ACHIEVEMENTS_COUNT = 119;
    static SCRAPBOOK_COUNT = 2396;
    ...
    #initCharacterSave (data, legacyDungeons) {
    ...
    #initStatusSave (data, resources) {
        ...
        this.Mushrooms.Total = this.Mushrooms.Free + this.Mushrooms.Paid;
