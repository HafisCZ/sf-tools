        ...
        $('#container-detail-stats').html(`
            <tbody>
                ...
                <tr>
                    ...
                    ${ prefs['show-treasure'] ? `<td ${ prefs['treasure-enabled'] ? (group.Treasures.Min >= prefs['treasure-req'] ? 'class="foreground-green"' : (group.Treasures.Min >= prefs['treasure-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Treasures.Min }${ (prefs['treasure-difference'] && group.Treasures.Min != oldgroup.Treasures.Min) ? `<span> ${ group.Treasures.Min > oldgroup.Treasures.Min ? '+' : '' }${ group.Treasures.Min - oldgroup.Treasures.Min }</span>` : '' }</td>` : ''}
                    ${ prefs['show-instructor'] ? `<td ${ prefs['instructor-enabled'] ? (group.Instructors.Min >= prefs['instructor-req'] ? 'class="foreground-green"' : (group.Instructors.Min >= prefs['instructor-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Instructors.Min }${ (prefs['instructor-difference'] && group.Instructors.Min != oldgroup.Instructors.Min) ? `<span> ${ group.Instructors.Min > oldgroup.Instructors.Min ? '+' : '' }${ group.Instructors.Min - oldgroup.Instructors.Min }</span>` : '' }</td>` : ''}
                    ${ prefs['show-pet'] ? `<td ${ prefs['pet-enabled'] ? (group.Pets.Min >= prefs['pet-req'] ? 'class="foreground-green"' : (group.Pets.Min >= prefs['pet-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Pets.Min }${ (prefs['pet-difference'] && group.Pets.Min != oldgroup.Pets.Min) ? `<span> ${ group.Pets.Min > oldgroup.Pets.Min ? '+' : '' }${ group.Pets.Min - oldgroup.Pets.Min }</span>` : '' }</td>` : ''}
                ...
                <tr>
                    ...
                    ${ prefs['show-treasure'] ? `<td ${ prefs['treasure-enabled'] ? (group.Treasures.Avg >= prefs['treasure-req'] ? 'class="foreground-green"' : (group.Treasures.Avg >= prefs['treasure-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ Math.trunc(group.Treasures.Avg) }${ (prefs['treasure-difference'] && Math.trunc(group.Treasures.Avg) != Math.trunc(oldgroup.Treasures.Avg)) ? `<span> ${ group.Treasures.Avg > oldgroup.Treasures.Avg ? '+' : '' }${ Math.trunc(group.Treasures.Avg) - Math.trunc(oldgroup.Treasures.Avg) }</span>` : '' }</td>` : ''}
                    ${ prefs['show-instructor'] ? `<td ${ prefs['instructor-enabled'] ? (group.Instructors.Avg >= prefs['instructor-req'] ? 'class="foreground-green"' : (group.Instructors.Avg >= prefs['instructor-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ Math.trunc(group.Instructors.Avg) }${ (prefs['instructor-difference'] && Math.trunc(group.Instructors.Avg) != Math.trunc(oldgroup.Instructors.Avg)) ? `<span> ${ group.Instructors.Avg > oldgroup.Instructors.Avg ? '+' : '' }${ Math.trunc(group.Instructors.Avg) - Math.trunc(oldgroup.Instructors.Avg) }</span>` : '' }</td>` : ''}
                    ${ prefs['show-pet'] ? `<td ${ prefs['pet-enabled'] ? (group.Pets.Avg >= prefs['pet-req'] ? 'class="foreground-green"' : (group.Pets.Avg >= prefs['pet-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ Math.trunc(group.Pets.Avg) }${ (prefs['pet-difference'] && Math.trunc(group.Pets.Avg) != Math.trunc(oldgroup.Pets.Avg)) ? `<span> ${ group.Pets.Avg > oldgroup.Pets.Avg ? '+' : '' }${ Math.trunc(group.Pets.Avg) - Math.trunc(oldgroup.Pets.Avg) }</span>` : '' }</td>` : ''}
                ...
                <tr>
                    ...
                    ${ prefs['show-treasure'] ? `<td ${ prefs['treasure-enabled'] ? (group.Treasures.Max >= prefs['treasure-req'] ? 'class="foreground-green"' : (group.Treasures.Max >= prefs['treasure-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Treasures.Max }${ (prefs['treasure-difference'] && group.Treasures.Max != oldgroup.Treasures.Max) ? `<span> ${ group.Treasures.Max > oldgroup.Treasures.Max ? '+' : '' }${ group.Treasures.Max - oldgroup.Treasures.Max }</span>` : '' }</td>` : ''}
                    ${ prefs['show-instructor'] ? `<td ${ prefs['instructor-enabled'] ? (group.Instructors.Max >= prefs['instructor-req'] ? 'class="foreground-green"' : (group.Instructors.Max >= prefs['instructor-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Instructors.Max }${ (prefs['instructor-difference'] && group.Instructors.Max != oldgroup.Instructors.Max) ? `<span> ${ group.Instructors.Max > oldgroup.Instructors.Max ? '+' : '' }${ group.Instructors.Max - oldgroup.Instructors.Max }</span>` : '' }</td>` : ''}
                    ${ prefs['show-pet'] ? `<td ${ prefs['pet-enabled'] ? (group.Pets.Max >= prefs['pet-req'] ? 'class="foreground-green"' : (group.Pets.Max >= prefs['pet-min'] ? 'class="foreground-orange"' : 'class="foreground-red"')) : '' }>${ group.Pets.Max }${ (prefs['pet-difference'] && group.Pets.Max != oldgroup.Pets.Max) ? `<span> ${ group.Pets.Max > oldgroup.Pets.Max ? '+' : '' }${ group.Pets.Max - oldgroup.Pets.Max }</span>` : '' }</td>` : ''}
